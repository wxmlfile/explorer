    ...
    if (this.state.hasError) {
      ...
      return (
        <div style={{padding: 20}}>
          ...
          Consider <a href="https://github.com/wxmlfile/explorer/issues/new?template=bug_report.md">filing a bug report</a>, but <a href="https://github.com/wxmlfile/explorer/issues/">check first</a> if one doesn&quot;t already exist. Thank you!
				</div>
			);
    }
